...
const heroAccentSurface =
  "border-[__HERO_BORDER_LIGHT__]/80 dark:border-slate-800/50 card-gradient-bg";

const portraitCardShell =
  "relative rounded-[2rem] overflow-hidden transition-transform duration-150 ease-out will-change-transform bg-gradient-to-b from-white via-[#fdf7f0] to-[#f3e6d6] border border-[__HERO_BORDER_LIGHT__]/80 shadow-lg shadow-slate-900/10 dark:from-slate-900/90 dark:via-slate-950/95 dark:to-black/98 dark:border-slate-800/70 dark:shadow-[0_20px_60px_rgba(15,23,42,0.75)]";
...
const socialLinksShell = `group relative flex items-center justify-center gap-4 overflow-hidden rounded-md border-2 ${heroAccentSurface} px-6 py-3 shadow-sm hover:border-[__HERO_BORDER_LIGHT__] hover-glow`;
...
export function Hero() {
  ...
  return (
    <SectionContainer variant="hero" id="home">
      <div className="mt-20 flex flex-col items-center gap-6 sm:mt-16 md:mt-12 lg:mt-0 lg:grid lg:grid-cols-2 lg:items-start lg:gap-12">
        {/* Left Column - Content */}
        <div className="space-y-6 order-1 lg:order-1 text-center lg:text-left w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center lg:items-start sm:items-center gap-3 pt-10">
            ...
            <Button
              ...
              className={`group relative h-11 overflow-hidden border-2 ${heroAccentSurface} px-6 text-sm font-semibold text-slate-900 shadow-sm hover:border-[__HERO_BORDER_LIGHT__] hover-glow dark:text-foreground dark:hover:bg-accent`}
            >
              ...
              >
                ...
                <div className={portraitFooter}>
                  <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    <div className={`h-8 w-8 ${portraitLogoBadge}`}>
                      __AUTHOR_INITIALS__
                    </div>
                  </div>
              ...
              <div className="flex w-[21.5rem] items-center justify-center pt-12">
                <div className={socialLinksShell}>
                  ...
                  <div className="relative z-10 flex items-center justify-center gap-4">
                    <a
                      href="https://github.com/__GITHUB_USERNAME__"
                      target="_blank"

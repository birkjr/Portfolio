  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative w-full max-w-7xl mx-auto rounded-3xl overflow-hidden border-2 border-[__HERO_BORDER_LIGHT__]/80 shadow-lg shadow-slate-900/10 backdrop-blur-[4px] dark:border-slate-800/50 dark:shadow-2xl dark:shadow-black/40 card-gradient-bg">

...
export function Footer() {
  ...
  return (
    <SectionContainer id="contact" variant="featured">
      ...
      <footer
        ref={sectionRef}
        className={`group relative w-full rounded-3xl overflow-hidden border-2 border-[__HERO_BORDER_LIGHT__]/80 dark:border-slate-800/50 shadow-lg shadow-slate-900/10 backdrop-blur-[4px] dark:shadow-2xl dark:shadow-black/40 card-gradient-bg hover-glow transition-all duration-500 ${

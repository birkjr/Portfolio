...
import { Code, Users, TrendingUp, Star, Brain, LucideIcon, X } from "lucide-react";
...
const experiences_en: Experience[] = [
  ...
  },
  {
    ...
    year: "2024",
    icon: Users,
    detailedDescription: "As Marketing Team Leader at EMIL-Link, I led a team with focus on negotiation, collaboration, and strategic marketing. In addition to the leadership responsibility, I took on the role of developing the organization's official website from scratch, using modern web technologies. This project combined my technical skills with leadership qualities and gave me deep insight into how technology can be used to strengthen a company's marketing efforts."
  },
  {
    title: "Marketing Team Member",
            ...
            >
              ...
              <CardHeader>
                <div className="flex items-start gap-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                    {(() => {
                      const IconComponent = experiences[selectedExperience].icon;
                      return <IconComponent className="w-8 h-8 text-white" />;
                    })()}
                  </div>
                  <div className="flex-1 min-w-0">
                    <CardTitle className="text-2xl mb-2">{experiences[selectedExperience].title}</CardTitle>
              ...
              <CardContent>
                <p className="text-lg text-muted-foreground/90 leading-relaxed">
                  {experiences[selectedExperience].detailedDescription || experiences[selectedExperience].description}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          {experiences.map((experience, index) => {
            ...
            return (
              <Card
                ...
                style={{
                  opacity: selectedExperience !== null && selectedExperience !== index ? 0.3 : 1,
                  transform: selectedExperience === index ? 'scale(1.05)' : 'scale(1)',
                }}
              >
                <CardHeader>
